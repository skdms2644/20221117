...
var pendulum = Composites.stack(260, 270, 2, 1, -20, 0, function (x, y) {
...
Events.on(render, "afterRender", function () {
  ...
  for (var i = 0; i < trail.length; i += 1) {
    ...
    var hue = 400 + Math.round((1 - Math.min(1, speed / 50)) * 170);
    render.context.fillStyle = "hsl(" + hue + ", 100%, 55%)";
    render.context.fillRect(point.x, point.y, 150, 2);
  }
